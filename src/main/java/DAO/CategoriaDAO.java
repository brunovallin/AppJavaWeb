...
public class CategoriaDAO extends BaseDAO {
	...
	public void newCategoria(Categoria p) throws Exception {
	...
	public void editCategoria(Categoria p)  throws Exception{
		  abrir();
			
	      String query = " update Categoria set nome=? where id=?";
	      PreparedStatement preparedStmt = getConn().prepareStatement(query);
	      preparedStmt.setString (1, p.getNome());    
	      preparedStmt.setInt(2, p.getCodigo()); 
	      preparedStmt.execute();
	      fechar();
		
	}
	public void deleteCategoria(Categoria p) throws Exception{
		  abrir();
