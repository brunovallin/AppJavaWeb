...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div class="container">
		<div class="card container mt-5" style="background-color: #35858b">
			<div class="card-body">
				<h3 class="card-title" style="color: white">Cadastro de Cargo</h3>
				...
				<div class="container card" style="background-color: #4fbdba">
					...
					<form action="CadastroCargo" method="post" class="card-body mt-5 mb-2">
						<div class="d-flex justify-content-between">
							<input type="hidden" name="id" id="id" value="<c:out value='${vo.codigo}'/>">
						...
						<div class="d-flex justify-content-end mb-3 me-4">
							<div class="btn-group">
								<a class="btn btn-outline-dark" href="ListaCargo">Pesquisar</a>
